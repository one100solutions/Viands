            ...
            Account(dateForAccount, function (err, accountInfo) {
                ...
                json2csv({
                     ...
                     console.log('Error occured', err);
                         ...
                         csv += ",,,Total Ordered Today," + accountInfo.ordered + ",Total Credited today," + accountInfo.credited + ",";  
...
function mail (finalAccounts) {
    ...
    fs.readFile("Account.csv", function(err, data) {
        ...
        mailer('akashshakdwipeea@gmail.com',template(Acc), data, function (Err, Success) {
