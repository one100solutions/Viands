            ...
            Account(dateForAccount, function (err, accountInfo) {
                ...
                json2csv({
                     ...
                     console.log('Error occured', err);
                         ...
                         fs.writeFile(__dirname + '/../data/' + curDate.format("dddd, MMMM Do YYYY") + ".csv", csv, function (err) {
                         console.log(err);
			if(err) throw err
                          mail(accountInfo);
                     })
...
function mail (finalAccounts) {
    ...
    fs.readFile(__dirname + '/../data/' + curDate.format("dddd, MMMM Do YYYY") + ".csv", function(err, data) {
        console.log(err)
	...
	attachFile.data = data;
        ...
        mailer('sidsb94@gmail.com',template(Acc), attachFile, function (Err, Success) {
