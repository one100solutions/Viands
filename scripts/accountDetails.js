...
// for (var i = 29; i < 31; i++) {
		...
		if (process.argv[4] == "all") {
			var totalOrdered = 0,
					...
					ordered = [],
					credited = [],
					day = dateForAccount.day,
					month = dateForAccount.month,
					today = moment(),
					counter = 0,
					doneCounter = 0;

			var _date = moment([dateForAccount.year, dateForAccount.month - 1, dateForAccount.day]);

			while (_date.isBefore(today)) {
